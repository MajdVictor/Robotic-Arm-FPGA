...
HD_PWD='/home/mvh/Desktop/fpga/servo/servo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_3.tcl
