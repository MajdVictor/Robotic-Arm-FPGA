...
HD_PWD='/home/mvh/Desktop/fpga/servo/servo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project_3.tcl -notrace
